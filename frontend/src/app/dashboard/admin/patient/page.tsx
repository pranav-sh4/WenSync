      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-2xl overflow-hidden">
          ...
          <CardContent className="p-0 relative">
            ...
            {isLoading && (
              <div className="absolute inset-0 bg-white/90 backdrop-blur-sm z-10 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 font-medium">Loading Patient System...</p>
            ...
            <div className="relative w-full h-[calc(100vh-280px)] min-h-[600px]">
              <iframe
                src="https://r8pzcgbc-8502.inc1.devtunnels.ms/"
              ...
              {!isOnline && (
                <div className="absolute inset-0 bg-gray-100 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <p className="text-gray-600 mb-4">Unable to connect to the Patient system</p>
                    <Button
                      onClick={() => {
                        setIsOnline(true)
                        handleRefresh()
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">
            Patient Management System • Last updated: {lastUpdated.toLocaleString()} •
